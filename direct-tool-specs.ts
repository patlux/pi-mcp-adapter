// Startup-light module: pure config/cache munging needed at extension factory
// time. Must NOT import the heavy MCP graph (SDK, server-manager, panels) so
// that pi startup stays fast; the heavy executor lives in ./direct-tools.ts
// and is loaded lazily on first use.
